<!-- Modal Edicion-->
<div id="myModalNewReason" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="gridModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">

            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="gridModalLabel">Razon social principal</h4>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('numberClient',null,['id'=>'numberClient1','class'=>'form-control','placeholder'=>'Numero del ciente','required','autofocus']) !!}
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        {!! Form::label('main','Razones de Cliente') !!}
                                        {!! Form::select('main', [],null,['id'=>'nameReason1','class'=>'form-control ','placeholder'=>'Seleccione una ciudad'])!!}
                                    </div>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('phoneContact',null,['id'=>'phoneContact1','class'=>'form-control','placeholder'=>'telefono fijo','autofocus']) !!}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('cellContact',null,['id'=>'cellContact1','class'=>'form-control','placeholder'=>'Número móvil celular']) !!}
                                    </div>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::text('nameReason',null,['id'=>'nameReason1','class'=>'form-control','placeholder'=>'Denominación social','required']) !!}
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        {!! Form::select('city', [],null,['id'=>'city1','class'=>'form-control ','placeholder'=>'Seleccione una ciudad'])!!}
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
