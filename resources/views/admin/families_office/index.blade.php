...
@section('title',' Familias Oficina Central')

@section('content')
    <div class="text-center"><h1>Catálogo de Familias de Oficina Central</h1></div></br></br>
    <div  style="max-width: 900px; margin: auto;">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="gridModalLabel">Registro de Familias de Oficina Central</h4>
                    </div>
                        ...
                        <div class="container-fluid bd-example-row">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    {!! Form::open(['route'=>'admin.families_office.store', 'method'=>'POST']) !!}
                                    @if($configKey=="manual")
        ...
        <div class="table-responsive" style="margin-bottom: 10px;">
                            ...
                            @elseif($configKey=="manual")
                                @if($perm_btn[0]->update==1)
                                    <a href="#"
                                       data-type="text"
                                       data-pk="{{$families->id}}"
                                       data-url="{{url("admin/families_office/$families->id")}}"
            ...
            {!! Form::open(['route'=> ['admin.families_office.destroy',':USER_ID'],'method'=>'DELETE', 'id'=>'form-delete']) !!}
